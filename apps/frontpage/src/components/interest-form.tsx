...
export default function InterestForm() {
  ...
  useEffect(() => {
    if (!isDiagOpen && !form.formState.isValid && attemptedSubmit) {
      setIsDiagOpen(true);
  ...
  return (
    <>
                ...
                <DialogContent className="max-h-[75%] overflow-y-scroll">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      environment. Providing this information is optional and
                      will help us understand the demographics of our
                      participants. All information will be kept confidential
                  ...
                  <Dialog>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          HackUTA is partnered with Major League Hacking (MLH)
                          and adheres to their Code of Conduct. Please review
                          the information below before submitting your interest
                          form.
                        </DialogDescription>
                      </DialogHeader>
                      <FormField
      ...
      <Dialog open={showSubmittedDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Form submitted</DialogTitle>
            <DialogDescription>
              Thanks for your interest in HackUTA! We&apos;ll email you updates
              and next steps soon.
            </DialogDescription>
          </DialogHeader>
          <DialogClose asChild>
            <Button type="button" onClick={() => setShowSubmittedDialog(false)}>
              Close
            </Button>
          </DialogClose>
        </DialogContent>
